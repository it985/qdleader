import{_ as e,c as s,o as n,a}from"./app-90N25QkG.js";const i={},l=a(`<h1 id="require加载原理" tabindex="-1"><a class="header-anchor" href="#require加载原理"><span>require加载原理</span></a></h1><h2 id="require-模块引入与处理" tabindex="-1"><a class="header-anchor" href="#require-模块引入与处理"><span>require 模块引入与处理</span></a></h2><blockquote><p>CommonJS 模块同步加载并执行模块文件，CommonJS 模块在执行阶段分析模块依赖，采用深度优先遍历（depth-first traversal），执行顺序是父 -&gt; 子 -&gt; 父；</p></blockquote><p>eg:</p><p>a.js文件</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">const getMes = require(&#39;./b&#39;)</span>
