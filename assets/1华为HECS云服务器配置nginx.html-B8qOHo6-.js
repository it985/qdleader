import{_ as n,c as e,o as s,a}from"./app-90N25QkG.js";const i={},r=a(`<h1 id="_1华为hecs云服务器配置nginx" tabindex="-1"><a class="header-anchor" href="#_1华为hecs云服务器配置nginx"><span>1华为HECS云服务器配置nginx</span></a></h1><h2 id="一、安装开发工具和依赖库" tabindex="-1"><a class="header-anchor" href="#一、安装开发工具和依赖库"><span>一、安装开发工具和依赖库</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">yum <span class="token parameter variable">-y</span> <span class="token function">install</span> <span class="token function">make</span> zlib zlib-devel gcc-c++ libtool  openssl openssl-devel</span>
