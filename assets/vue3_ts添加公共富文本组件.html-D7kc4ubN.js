import{_ as n,c as s,o as i,a}from"./app-90N25QkG.js";const l={},e=a(`<h1 id="vue3-ts添加公共富文本组件" tabindex="-1"><a class="header-anchor" href="#vue3-ts添加公共富文本组件"><span>vue3+ts添加公共富文本组件</span></a></h1><h2 id="vue3-ts添加公共富文本组件-1" tabindex="-1"><a class="header-anchor" href="#vue3-ts添加公共富文本组件-1"><span>vue3+ts添加公共富文本组件</span></a></h2><h2 id="下载" tabindex="-1"><a class="header-anchor" href="#下载"><span>下载</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">npm install wangeditor --save-dev</span>
