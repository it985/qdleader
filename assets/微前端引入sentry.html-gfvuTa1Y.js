import{_ as n,c as s,o as a,a as p}from"./app-90N25QkG.js";const e={},t=p(`<h1 id="微前端-引入-sentry" tabindex="-1"><a class="header-anchor" href="#微前端-引入-sentry"><span>微前端 引入 sentry</span></a></h1><h2 id="主应用中" tabindex="-1"><a class="header-anchor" href="#主应用中"><span>主应用中</span></a></h2><p>main.ts</p><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> sentryInitForVueSubApp <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;./sentry.ts&quot;</span></span>
