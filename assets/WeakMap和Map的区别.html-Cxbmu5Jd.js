import{_ as s,c as a,b as e,t as l,a as n,o as i}from"./app-90N25QkG.js";const p={},d=n(`<h1 id="weakmap和map的区别" tabindex="-1"><a class="header-anchor" href="#weakmap和map的区别"><span>WeakMap和Map的区别</span></a></h1><h2 id="map-的使用" tabindex="-1"><a class="header-anchor" href="#map-的使用"><span>map 的使用</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">map.set(key,value)添加键值对到映射中</span>
