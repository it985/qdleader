import{_ as n,c as s,o as e,a}from"./app-90N25QkG.js";const l={},i=a(`<h1 id="y003-强制和隐式类型转换" tabindex="-1"><a class="header-anchor" href="#y003-强制和隐式类型转换"><span>Y003-强制和隐式类型转换</span></a></h1><h2 id="强制" tabindex="-1"><a class="header-anchor" href="#强制"><span>强制:</span></a></h2><p>parseInt(), parseFloat(),toString(), Number(), Boolean(), String(),Math.round() Math.round():严格转换，不允许出现任何非数字的字符，否则NaN；取最接近的整数。 Number():严格转换，不允许出现任何非数字的字符，否则NaN；直接转换</p><h2 id="隐式" tabindex="-1"><a class="header-anchor" href="#隐式"><span>隐式:</span></a></h2><p>if, 逻辑运算, == ,|| &amp;&amp;, + - !</p><h2 id="常见解析" tabindex="-1"><a class="header-anchor" href="#常见解析"><span>常见解析</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// 1.parseInt() 把值转换成整数</span>
