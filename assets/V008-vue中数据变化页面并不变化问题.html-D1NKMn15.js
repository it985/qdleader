import{_ as s,c as n,o as e,a}from"./app-90N25QkG.js";const i={},l=a(`<h1 id="v008-vue中数据变化页面并不变化问题" tabindex="-1"><a class="header-anchor" href="#v008-vue中数据变化页面并不变化问题"><span>V008-vue中数据变化页面并不变化问题</span></a></h1><p>由于我们vue2中的数据双向绑定时候经常遇到这种，数据变化了，视图没有变化的情况，这是为什么呢？怎么解决呢？</p><h5 id="探索1" tabindex="-1"><a class="header-anchor" href="#探索1"><span>探索1</span></a></h5><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">data() {</span>
